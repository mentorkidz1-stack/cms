...
CREATE TABLE "new_Settings" (
    ...
    "templateId" TEXT NOT NULL DEFAULT 'cabinet-pro',
...
INSERT INTO "new_Settings" ("aboutContent", "addressCity", "addressLandmarks", "bannerImageUrl", "blogLabel", "blogSubheading", "contactEmail", "contactHeading", "contactSubheading", "defaultWhatsappMessage", "equipeLabel", "equipeSubheading", "formationsLabel", "formationsLabelSingular", "formationsSubheading", "googleMapsUrl", "heroSubtitle", "heroTitle", "id", "logoFontFamily", "logoFontSize", "logoHighlightWord", "logoType", "logoUrl", "momoDetails", "openingHours", "phoneNumber", "primaryColor", "servicesLabel", "servicesLabelSingular", "servicesSubheading", "showAbout", "showBlog", "showEquipe", "showFormations", "showGalerie", "showOnlineBadge", "showPartenaires", "showServices", "showTemoignages", "siteName", "whatsappNumber") SELECT "aboutContent", "addressCity", "addressLandmarks", "bannerImageUrl", "blogLabel", "blogSubheading", "contactEmail", "contactHeading", "contactSubheading", "defaultWhatsappMessage", "equipeLabel", "equipeSubheading", "formationsLabel", "formationsLabelSingular", "formationsSubheading", "googleMapsUrl", "heroSubtitle", "heroTitle", "id", "logoFontFamily", "logoFontSize", "logoHighlightWord", "logoType", "logoUrl", "momoDetails", "openingHours", "phoneNumber", "primaryColor", "servicesLabel", "servicesLabelSingular", "servicesSubheading", "showAbout", "showBlog", "showEquipe", "showFormations", "showGalerie", "showOnlineBadge", "showPartenaires", "showServices", "showTemoignages", "siteName", "whatsappNumber" FROM "Settings";
DROP TABLE "Settings";
